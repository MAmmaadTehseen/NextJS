                        ...
                        <form className="space-y-6" action="#" method="POST">
                            <div>
                                ...
                                <div className="mt-2">
                                    ...
                                    {user.name.split(" ").length < 2 && user.name && error ? (
                                        <StyledErrorMessage>
                                            Please enter last and first name
                                        </StyledErrorMessage>
                                    ) : null}
                                    {!user.name && error ? (
                                        <StyledErrorMessage>
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    ...
                                    {user.email && error == "User already exists" ? (
                                        <StyledErrorMessage>
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    ...
                                    {user.password.length < 6 && user.password && error ? (
                                        <StyledErrorMessage>
                                            Use a 6 digits password
                                        </StyledErrorMessage>
                                    ) : null}
                                    {!user.password && error ? (
                                        <StyledErrorMessage>
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    ...
                                    {user.password != password2 && password2 && error ? (
                                        <StyledErrorMessage>
